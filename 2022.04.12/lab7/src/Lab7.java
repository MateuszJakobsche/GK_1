...
public class Lab7 extends JPanel implements GLEventListener {
	...
	private float a = 1F;
	private float z = (float)(2*a/Math.sqrt(2)); 
	
	private void octagon(GL2 gl2) {
		gl2.glBegin(GL2.GL_TRIANGLE_FAN);
		gl2.glTexCoord2d(0.6, 1);
		gl2.glVertex3f(-a, -2, +a+z);		
		gl2.glTexCoord2d(0.8 , 1);
		gl2.glVertex3f(+a, -2, +a+z);
		gl2.glTexCoord2d(1 , 0.7);
		gl2.glVertex3f(+a+z, -2, +a);
		gl2.glTexCoord2d(1 , 0.3);
		gl2.glVertex3f(+a+z, -2, -a);
		gl2.glTexCoord2d(0.8 , 0);
		gl2.glVertex3f(+a, -2, -a-z);
		gl2.glTexCoord2d(0.6 , 0);
		gl2.glVertex3f(-a, -2, -a-z);
		gl2.glTexCoord2d(0.4 , 0.3);
		gl2.glVertex3f(-a-z, -2, -a);
		gl2.glTexCoord2d(0.4 , 0.7);
		gl2.glVertex3f(-a-z, -2, +a);
		gl2.glEnd();		
	}
	
	private void pyramidSide(GL2 gl2) {
		gl2.glBegin(GL2.GL_TRIANGLE_FAN);
		gl2.glTexCoord2d(0.1 , 0.2);
		gl2.glVertex3f(-a, -2, +a+z);
		gl2.glTexCoord2d(0.3 , 0.2);
		gl2.glVertex3f(+a, -2, +a+z);
		gl2.glTexCoord2d(0.2 , 0.6);
	...
	public JMenuBar getMenuBar() {
		...
		makeMenuItem(objectMenu, "Pyramid", objectListener, 0);
		makeMenuItem(objectMenu, "Cube", objectListener, 1);
		makeMenuItem(objectMenu, "Cylinder", objectListener, 2);
		makeMenuItem(objectMenu, "Cone", objectListener, 3);
		makeMenuItem(objectMenu, "Sphere", objectListener, 4);
		makeMenuItem(objectMenu, "Torus", objectListener, 5);
		makeMenuItem(objectMenu, "Teapot", objectListener, 6);
		makeMenuItem(objectMenu, "Triangular Prism", objectListener, 7);
