...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, materials[3], 0);
		pyramid(gl2);
	} // end display()
	...
	public void init(GLAutoDrawable drawable) {
		...
		float lightColor [] = {1,1,1, 1,0,0, 0,0,1};
		float lightPosition [] = {-50, 8, 0, 0};
		gl2.glEnable(GL2.GL_LIGHT0);
		gl2.glLightfv(GL2.GL_LIGHT0, GLLightingFunc.GL_POSITION, lightPosition, 0);
		gl2.glLightfv(GL2.GL_LIGHT0, GL2.GL_SPECULAR, lightColor, 0);
		gl2.glLightfv(GL2.GL_LIGHT0, GL2.GL_DIFFUSE, lightColor, 0);
		gl2.glLightfv(GL2.GL_LIGHT0, GL2.GL_AMBIENT, lightColor, 0);
